...
func (r *queryResolver) Expenditures(ctx context.Context, since *string, until *string, source *string, count *int) ([]*model.ExpenditureResponse, error) {
	...
	expenditures, err := database.ListExpenditures(ctx, r.Pool, sinceTime, untilTime, source, limit)
	if err != nil {
		return []*model.ExpenditureResponse{}, err
	}
